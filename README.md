...
class MyTestCase(unittest.TestCase):
    def test_something(self):
        ...
        expected_decoded_json = [{'type': 'StatementSequence', 'children': [1]},
                                 ...
                                 {'type': 'list_statements', 'children': [23]},
                                 {'type': 'Play', 'children': [24]},
                                 {'type': 'scalar_note', 'children': [25]},
                                 {'type': 'StringLiteral', 'value': '65'},
                                 {'type': 'UseSynth', 'children': [27]},
                                 {'type': 'scalar_synth_name', 'children': [28]},
                                 {'type': 'StringLiteral', 'value': ':5'},
                                 {'type': 'Play', 'children': [30]},
                                 {'type': 'scalar_note', 'children': [31]},
                                 {'type': 'StringLiteral', 'value': '63'}]
